...
export type TranslationProvenance = {route:string[];model_revisions:string[];pivoted:boolean;warnings?:string[]};
export type Report = {id: string; source: string; original_text: string; original_language: string; address_raw: string | null; processing_status: string; analysis: {translated_text?: Record<string,string>; translation_provenance?:Record<string,TranslationProvenance>;warnings?: string[]; pipeline_version?: string;location_candidates?:LocationCandidate[]}};
