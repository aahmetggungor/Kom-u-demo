...
| KOMSU-FUNC-011 | s.2 saha; s.3 | Kotlin/Jetpack Compose Android, çevrimdışı rapor yazma ve bağlantıda sync | Uçak modu, process death, yeniden bağlantı testi | PARTIAL |
...
| Kalite / güvenlik | Toplam 88 Python testi (9 gerçek PG); Python lint, pip-audit ve Bandit; web build/6 test; Android build/lint; encrypted audio scan/release/transcript, retention/hold/restore kanıtı | Uzak CI çalışmadı; gerçek scanner, saha sesi, container bulguları, hukuk onayı, cache/backup re-purge ve pentest eksik |
